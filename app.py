...
if st.button('Predict Score'):
    ...
    if batting_team == bowling_team and overs < 5:
        st.text("PLEASE ENTER APPROPRIATE DATA...")
    elif batting_team == bowling_team:
        st.text("THE TEAM THAT IS BATTING CANNOT ALSO BE THE TEAM THAT IS BOWLING...")
    elif overs < 5:
        st.text("THE NUMBER OF OVERS COMPLETED MUST BE GREATER THAN 5...")
    else:
